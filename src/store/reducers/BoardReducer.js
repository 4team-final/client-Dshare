...
export default function boardReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case BOARDLIST_AFTER_GET_ERROR:
            return handleAsyncActions(BOARDLIST_AFTER_GET, 'boardListAfter')(state, action);
        ...
        case CATEGORYLIST_GET_ERROR:
            return handleAsyncActions(CATEGORYLIST_GET, 'categoryList')(state, action);
        case MATERIALLIST_GET:
        case MATERIALLIST_GET_SUCCESS:
        case MATERIALLIST_GET_ERROR:
            return handleAsyncActions(MATERIALLIST_GET, 'searchMaterialList')(state, action);
        case KEWORDBOARDLIST_GET:
        case KEWORDBOARDLIST_GET_SUCCESS:
        case KEWORDBOARDLIST_GET_ERROR:
            return handleAsyncActions(KEWORDBOARDLIST_GET, 'boardListKeyword')(state, action);
        case KEWORDBOARDLIST_AFTER_GET:
        case KEWORDBOARDLIST_AFTER_SUCCESS:
        case KEWORDBOARDLIST_AFTER_ERROR:
            return handleAsyncActions(KEWORDBOARDLIST_AFTER_GET, 'boardListKeywordAfter')(state, action);
        case BOARDLISTVIEW_AFTER_GET:
        case BOARDLISTVIEW_AFTER_GET_SUCCESS:
        case BOARDLISTVIEW_AFTER_GET_ERROR:
            return handleAsyncActions(BOARDLISTVIEW_AFTER_GET, 'boardListAfterView')(state, action);
