...
export default function UserReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case USERINFORMATION_GET_ERROR:
            return handleAsyncActions(USERINFORMATION_GET, 'userInformation')(state, action);
        case USERMATERIAL_GET:
        case USERMATERIAL_GET_SUCCESS:
        case USERMATERIAL_GET_ERROR:
            return handleAsyncActions(USERMATERIAL_GET, 'userMaterialList')(state, action);
        case REFRIGERATOR_GET:
        case REFRIGERATOR_GET_SUCCESS:
        case REFRIGERATOR_GET_ERROR:
            return handleAsyncActions(REFRIGERATOR_GET, 'userRefrigeratorList')(state, action);
        case BOARD_RANK_CHECK:
        case BOARD_RANK_CHECK_SUCCESS:
        case BOARD_RANK_CHECK_ERROR:
            return handleAsyncActions(BOARD_RANK_CHECK, 'voteBoardRankList')(state, action);
        case VOTE_BOARD_RANK:
        case VOTE_BOARD_RANK_SUCCESS:
        case VOTE_BOARD_RANK_ERROR:
            return handleAsyncActions(VOTE_BOARD_RANK, 'voteboardrank')(state, action);
        case DID_VOTE_CHECK:
