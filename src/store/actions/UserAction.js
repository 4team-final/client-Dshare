...
export const signupform = createPromiseThunk(SIGNUPFORM_INSERT, UserApi.insertSignupForm);

export const userInformation = createPromiseThunk(USERINFORMATION_GET, UserApi.selectUserInformation);

export const userMaterialOne = createPromiseThunk(USERMATERIAL_POST, UserApi.saveUserMaterialOne);
export const userMaterialUserId = createPromiseThunk(USERMATERIAL_GET, UserApi.findUserMaterialUserId);

export const pwChange = createPromiseThunk(PASSWORD_UPDATE, UserApi.updatePassword);

export const deleteUserGetMaterial = createPromiseThunk(USERMATERIAL_DELETE, UserApi.deleteUserGetMaterialUserId);
...
export const searchRefrigerator = createPromiseThunk(REFRIGERATOR_GET, UserApi.searchRefrigeratorList);

export const updateUserInfo = createPromiseThunk(USERINFO_UPDATE, UserApi.updateUserInfo);
...
export const boardRankChk = createPromiseThunk(BOARD_RANK_CHECK, UserApi.boardRankSend);
...
export const voteboardRank = createPromiseThunk(VOTE_BOARD_RANK, UserApi.getrankboard);
...
export const didVoteChk = createPromiseThunk(DID_VOTE_CHECK, UserApi.userVoteValid);
