...
export const MY_RESERVATION_ROOM_DELETE_SUCCESS =
  "MY_RESERVATION_ROOM_DELETE_SUCCESS";
export const MY_RESERVATION_ROOM_DELETE_ERROR =
  "MY_RESERVATION_ROOM_DELETE_ERROR";

export const MY_RESERVATION_VEHICLE_DELETE = "MY_RESERVATION_VEHICLE_DELETE";
export const MY_RESERVATION_VEHICLE_DELETE_SUCCESS =
  "MY_RESERVATION_VEHICLE_DELETE_SUCCESS";
export const MY_RESERVATION_VEHICLE_DELETE_ERROR =
  "MY_RESERVATION_VEHICLE_DELETE_ERROR";
...
export const myReservationDeleteRoom = createPromiseThunk(
  MY_RESERVATION_ROOM_DELETE,
  ReserveApi.deleteMyReservationRoom
);
export const myReservationDeleteVehicle = createPromiseThunk(
  MY_RESERVATION_VEHICLE_DELETE,
  ReserveApi.deleteMyReservationVehicle
);
