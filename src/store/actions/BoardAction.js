...
export const BOARDLISTVIEW_AFTER_GET_SUCCESS = 'BOARDLISTVIEW_AFTER_GET_SUCCESS';
export const BOARDLISTVIEW_AFTER_GET_ERROR = 'BOARDLISTVIEW_AFTER_GET_ERROR';

export const boardList = createPromiseThunk(BOARDLIST_GET, BoardApi.findBoardAll);
export const boardListAfter = createPromiseThunk(BOARDLIST_AFTER_GET, BoardApi.findBoardAllAfter);

export const categoryList = createPromiseThunk(CATEGORYLIST_GET, BoardApi.findBoardCategory);
export const searchMaterialList = createPromiseThunk(MATERIALLIST_GET, BoardApi.findMaterial);

export const boardDetail = createPromiseThunk(BOARDDETAIL_GET, BoardApi.findBoardDetail);
export const boardSaveOne = createPromiseThunk(BOARD_POST, BoardApi.saveBoardOne);
export const kewordBoardList = createPromiseThunk(KEWORDBOARDLIST_GET, BoardApi.findkeyword);

export const kewordBoardListAfter = createPromiseThunk(KEWORDBOARDLIST_AFTER_GET, BoardApi.findkeywordAfter);

export const boardListAfterView = createPromiseThunk(BOARDLISTVIEW_AFTER_GET, BoardApi.findBoardAllAfterView);
